...
string generate_password(int num_words) {
    ...
    for (int i = 0; i < num_words; i++) {
        word_list.push_back(words[rand() % words.size()]);
    }
    for (string word : word_list) {
        password += word;
    }
    cout << "Generated version password: " << password << endl;
    return password;
}

string replace_with_uppercase(string password) {
    int index = rand() % password.length();
    password[index] = toupper(password[index]);
    cout << " uppercase password: " << password << endl;
    return password;
}
...
string swap_letters(string password) {
    ...
    cout << "Swapped pass: " << password << endl;
    return password;
}

bool search_letter(string password, char letter) {
    bool found = (find(password.begin(), password.end(), toupper(letter)) != password.end());
    if (found) {
        cout << "The letter is in the password." << endl;
    } else {
        cout << "The letter  is not in the password." << endl;
    }
    return found;
}
...
int main() {
    ...
    int num_words;
    cout << "Enter number 3 to 7: ";
    cin >> num_words;

    string password = generate_password(num_words);
